          ...
          child: Column(
            ...
            children: [
              const Padding(
                ...
                child: Text(
                  'Описание теста:\n\n'
                  'С помощью стрелочек вам нужно указать направление полета ласточки. Ласточка будет находиться в кружке определенного цвета. Если кружок красный, укажите, откуда она летит; если синий — куда она летит. Тест длится 60 секунд. Если вы ошибетесь 3 раза, он завершится досрочно. Удачи!',
